...
namespace FusionClient.Utils.VRChat
{
    public static class SocialMenuUtils
    {
        ...
        {
            return APIStuff.GetSocialMenuInstance().transform.Find("Avatar").gameObject.GetComponent<PageAvatar>();
        }

        public static ApiAvatar GetSelectedApiAvatar()
        {
            return GetPageAvatar().field_Public_SimpleAvatarPedestal_0.field_Internal_ApiAvatar_0;
        }
        ...
        public static void SelectAPIUser(string userid)
        {
